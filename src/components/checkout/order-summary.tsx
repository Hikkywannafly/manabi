...
//       type="single"
//       collapsible
//       className="mx-auto w-full rounded-lg bg-background lg:bg-card"
//       defaultValue={props.expanded ? "order-summary" : undefined}
//     >
//       <AccordionItem value="order-summary">
//         <AccordionTrigger className="cursor-pointer px-4 text-md hover:no-underline">
...
//                     ) : (
//                       <div className="flex h-8.5 w-8.5 items-center justify-center rounded-lg bg-muted text-muted-foreground text-xl">
