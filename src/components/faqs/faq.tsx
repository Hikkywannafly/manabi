...
const faqs = [
  {
    ...
    answer:
      "Có! Bạn có thể dùng thử miễn phí với 5 ảnh đầu tiên. Sau đó, bạn có thể nâng cấp lên gói Premium để khôi phục không giới hạn với nhiều tính năng cao cấp hơn.",
  },
  {
    question: "AI khôi phục ảnh có chính xác không?",
    answer:
      "Công nghệ AI của chúng tôi được đào tạo trên hàng triệu bức ảnh lịch sử. Độ chính xác lên đến 95% với khả năng tự động điều chỉnh màu sắc, độ nét và loại bỏ khuyết điểm.",
  },
  {
    question: "Ảnh của tôi có được bảo mật không?",
    answer:
      "Tất nhiên rồi! Mọi ảnh đều được mã hóa end-to-end và lưu trữ trên server bảo mật. Chỉ bạn mới có quyền truy cập. Bạn có thể xóa ảnh bất cứ lúc nào.",
  },
  {
    question: "Tôi có thể khôi phục ảnh đen trắng thành màu không?",
    answer:
      "Có! Tính năng 'Color Revive' của Manabi sử dụng AI để tự động tô màu tự nhiên cho ảnh đen trắng dựa trên bối cảnh và đối tượng trong ảnh.",
  },
  {
    question: "Mất bao lâu để xử lý một bức ảnh?",
    answer:
      "Trung bình chỉ mất 5-10 giây cho mỗi ảnh ở chế độ Standard, và 20-30 giây cho chế độ 4K Ultra HD tùy thuộc vào độ phức tạp của ảnh.",
  },
  {
    question: "Tôi có thể tải ảnh gốc về không?",
    answer:
      "Có! Bạn có thể tải xuống ảnh đã khôi phục ở độ phân giải cao nhất (lên đến 4K) và giữ nguyên file gốc nếu muốn so sánh hoặc lưu trữ.",
  },
];
