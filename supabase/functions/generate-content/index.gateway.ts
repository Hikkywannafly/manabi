...
/**
 * Quiz Generation Edge Function - Gateway Version
 *
...
function mapParamsForPython(params?: GenerationParams) {
  ...
  return {
    ...
    number_of_questions: params.numberOfQuestions || 10,
    question_types: params.questionTypes || ["mixed"],
...
Deno.serve(async (req) => {
  ...
  try {
    console.log("🚀 Quiz generation gateway started");
    ...
    const backendResponse = await fetch(
      `${pythonBackendUrl}/api/v1/generate-quiz`,
      {
        method: "POST",
        headers: {
