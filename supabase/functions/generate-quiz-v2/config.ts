/**
 * Configuration for Quiz Generation V2 (RAG Pipeline)
 */
...
export const PROGRESS_STEPS: Record<string, ProgressStep> = {
  ...
  GENERATE: { percent: 80, message: "Generating quiz with AI..." },
  SAVE: { percent: 90, message: "Saving quiz..." },
...
export const ERROR_MESSAGES = {
  missingFields: "Missing required fields: content source or quizId",
